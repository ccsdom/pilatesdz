...
export function CrmPreview({ dayLabel, summary, attendance, analytics }: { attendance: ReactNode; analytics: ReactNode; summary: DaySummary; dayLabel: string }) {
  const stats = [
