...
export function PasswordForm() {
  ...
  if (done) return <p role="status">{code ? "Votre mot de passe est enregistré. Vous pouvez vous connecter." : "Si cette adresse dispose d’un compte, un lien de récupération est disponible. En démonstration locale, aucun e-mail réel n’est envoyé."}</p>;
