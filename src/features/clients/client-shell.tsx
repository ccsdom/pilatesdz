...
import { UsersRound, LayoutDashboard, KeyRound, CalendarDays, BookmarkCheck } from "lucide-react";
import { BrandLockup } from "@/components/brand/brand-lockup";
import { LogoutButton } from "@/features/auth/logout-button";

export function ClientShell({ centerId, children, active = "clients" }: { centerId: string; children: React.ReactNode; active?: "clients" | "planning" | "reservations" | "packages" | "cash" }) {
